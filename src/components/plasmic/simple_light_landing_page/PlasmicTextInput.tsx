...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: hV88TT7qSqn4/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___2RDyO)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__drprL)}
              role={"img"}
            />
          ),
