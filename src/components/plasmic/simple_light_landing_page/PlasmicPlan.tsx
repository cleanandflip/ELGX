...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: 5cRJRi3LWFl_/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pMje9)}>
        <div className={classNames(projectcss.all, sty.freeBox__tpP6V)}>
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__oRoP)}>
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__s4On)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___4HkvJ)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__wJtlm)}
                />
              </div>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox__mFkmE)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__ybzcN)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
