...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: FLq7eexFTSYZ/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__owtTi, {
          [sty.freeBoxlong__owtTiXZp6G]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__risIt, {
          [sty.freeBoxlong__risItxZp6G]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__t3Xjn)}
              role={"img"}
            />
          ),
