...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: DW2DDj_kTyOA/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: CHglFvfdOYYj/icon
...
function PlasmicHomeCta__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___1T6Zi)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xvgfj)}>
          <TextInput
      ...
      <div className={classNames(projectcss.all, sty.freeBox__dx4Xn)}>
        <SphereIcon
